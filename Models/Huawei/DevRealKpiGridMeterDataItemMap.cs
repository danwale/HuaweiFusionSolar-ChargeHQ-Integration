...
{
    public class DevRealKpiGridMeterDataItemMap : BaseDevRealKpiDataItemMap
    {
        [JsonConverter(typeof(HuaweiInvalidNAValueConverter))]
        public double? active_power { get; set; } // Active Power (kW)

        [JsonConverter(typeof(HuaweiInvalidNAValueConverter))]
        public double? reactive_power { get; set; } // Reactive Power (kVar)
