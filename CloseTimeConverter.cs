...
{
    /// <summary>
    /// The CloseTimeConverter was introduced because the Huawei FusionSolar API was returning the value "N/A" as a string instead of a close_time which should
    ...
    /// </summary>
    public class CloseTimeConverter : JsonConverter
    {
